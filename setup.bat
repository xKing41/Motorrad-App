...
title Schraeglage - Automatische Einrichtung und APK-Build (v4.8)

REM ================================================================
REM  SCHRAEGLAGE  -  Ein-Klick-Setup fuer Windows  (v4.8)
...
echo ==============================================================
echo    SCHRAEGLAGE  -  Automatische Einrichtung + APK-Build v4.8
echo ==============================================================
echo.
