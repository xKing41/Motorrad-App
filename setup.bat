...
title Schraeglage - Automatische Einrichtung und APK-Build (v4.3)

REM ================================================================
REM  SCHRAEGLAGE  -  Ein-Klick-Setup fuer Windows  (v4.3)
...
echo ==============================================================
echo    SCHRAEGLAGE  -  Automatische Einrichtung + APK-Build v4.3
echo ==============================================================
echo.
