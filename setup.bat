...
title Schraeglage - Automatische Einrichtung und APK-Build (v4.25)

REM ================================================================
REM  SCHRAEGLAGE  -  Ein-Klick-Setup fuer Windows  (v4.25)
...
echo ==============================================================
echo    SCHRAEGLAGE  -  Automatische Einrichtung + APK-Build v4.25
echo ==============================================================
echo.
