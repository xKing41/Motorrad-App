...
title Schraeglage - Automatische Einrichtung und APK-Build (v4.27)

REM ================================================================
REM  SCHRAEGLAGE  -  Ein-Klick-Setup fuer Windows  (v4.27)
...
echo ==============================================================
echo    SCHRAEGLAGE  -  Automatische Einrichtung + APK-Build v4.27
echo ==============================================================
echo.
